...
import com.andepuc.ED.TipoUsuario;
 ...
 */
@Stateless
@Path("com.andepuc.ed.tipousuario")
public class TipoUsuarioFacadeREST extends AbstractFacade<TipoUsuario> {
    ...
    public void create(TipoUsuario entity, Usuario usuario) {
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") Integer id, TipoUsuario entity, Usuario usuario) {
    ...
    public TipoUsuario find(@PathParam("id") Integer id, Usuario usuario) {
    ...
    @Override
    @Produces({"application/xml", "application/json"})
    public List<TipoUsuario> findAll(Usuario usuario) {
    ...
    @Path("{from}/{to}")
    @Produces({"application/xml", "application/json"})
    public List<TipoUsuario> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to, Usuario usuario) {
